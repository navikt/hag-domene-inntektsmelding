...
class BestemmendeFravaersdagKtTest :
    FunSpec({
        ...
        context("arbeidsgiverperiode påvirker sykmelding") {
            ...
            context("arbeidsgiverperioder med overlapp med sykmeldingsperioder") {
                ...
                test(
                    "arbeidsgiverperioder ekskluderer _ikke_ siste sykmeldingsperioder (utgår fra inntektsmeldingsgrunnlag) når gap kompenserer for egenmeldinger",
                ) {
